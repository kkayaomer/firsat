...
<tr>
    ...
    <td><input type="file" name="mus_profile"></td>
</tr>
<tr align="" center>
...
if (isset($_POST['register'])) {
    ...
    $mus_profile = $_FILES['mus_profile']['name'];
    $mus_profile_tmp = $_FILES['mus_profile']['tmp_name'];
    $mus_profile = "musteri_image" . DIRECTORY_SEPARATOR . $mus_profile;

    move_uploaded_file($mus_profile_tmp, $mus_profile);
    $insert_mus = "INSERT INTO `musteri` (`mus_ip`, `mus_adi`, `mus_soyadi`, `mus_email`, `mus_sifre`, `mus_ulke`, `mus_sehir`, `mus_adres`, `mus_telefon`, `mus_profile`)
       values ('$ip','$mus_adi','$mus_soyadi','$mus_email','$mus_sifre','$mus_ulke','$mus_sehir','$mus_adres','$mus_telefon','$mus_profile')";
